...
<body style=" height:100vh; background-image:url('https://as1.ftcdn.net/jpg/02/19/19/36/500_F_219193677_3a3HsAhYvz4hT8tJsjT2Xf16LyE3nXkh.jpg'); background-position: center;background-repeat: no-repeat;background-size: cover;">
  ...
  <div id="demo">
	  <h1>Stock Available in Shelf</h1>
	  <h2><form action="changeview" method="post">
    <button type="submit" name="byview" value="shelfview" class="btn btn-primary btn-block">Check stock available in Warehouse</button>
	</form></h2>
	  
	  <br>
	  <form name="f" action="changeview2" method="post">
	  ...
	  <button class="btn btn-primary btn-lg" type = "submit" name="view" value="vendor code" onchange="changeview()"><strong>  Group by vendor code</strong></button>&emsp;
